...
def get_intervals_between(binary_signal: List, start_idx:int=0, val:Union[int, List]=0):
...
if __name__ == "__main__":
    ...
    print(get_intervals_between(binary_signal=sig, val=-30))
